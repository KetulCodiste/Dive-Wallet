...
import { WalletContext } from "../Wallet/Index";
import Modal from "react-bootstrap/Modal";
import { TrustWalletButton } from "../Wallet/trustwallet";
    ...
    return(
        ...
        <header className="mainhead">
			<div className="container">
				<div className="top-head pb-1">
					<ul className="d-flex justify-content-end">
						<li><a href="#" target="_blank">Telegram</a></li>
						<li><a href="#" target="_blank" rel="noreferrer">Help</a></li>
					</ul>	
				</div>
				<div className="bottom-head d-flex justify-content-between align-items-end">
					<div className="logo">
					<Link to="/"><img src={logo} alt="Dive Wallet" width="80%" /></Link>
					</div>
					<div className="mobile-connect-button">
						{ wallet.getWalletConnectButton() }
					</div>
				</div>
			</div>		
			
			<div className={isClicked?"mobile-menu-wrap showmenu":"mobile-menu-wrap"} >
				<div className="mobile-logo pb-4">
					<a href="/"><img src={logo} alt="Dive wallet" /></a>	
				</div>
				<div className="close-menu position-absolute" onClick={() => setIsClicked(false)}>				
					<span></span>
					<span></span>
				</div>
				<ul className="mobile-support-menu">
        ...
        <Modal
          show={wallet.state.connectModal}
          onHide={() => wallet.hideWalletModal()}
        >
          <Modal.Body>
            <div className="wallet_btns">
              <button onClick={() => wallet.connectWallet()}>
                ...
                />
                <h3>MetaMask</h3>
                <span>For desktop web wallets</span>
              </button>
              <hr />
              <button onClick={() => wallet.connectToWalletConnect()}>
                <img
                  alt="..."
                ...
                />
                <h3>WalletConnect</h3>
                <span>For mobile app wallets</span>
              </button>
              <hr />
              <TrustWalletButton
                walletConnected={wallet.handleTrustWalletConnected}
              ></TrustWalletButton>
            </div>
          </Modal.Body>
        </Modal>
